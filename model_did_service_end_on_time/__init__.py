...
from brainer.schemas_df.features import (
    FeaturesServiceDidServiceEndOnTimePredictDFSchema,
    FeaturesServiceDidServiceEndOnTimeTrainDFSchema,
)


class ModelDidServiceEndOnTime(BaseCatBoostModel, metaclass=Singleton):
    """Class for CatBoost model model_did_service_end_on_time."""
    ...
    def __init__(self):
        ...
        super().__init__(
            target="did_service_end_on_time",
    ...
    @check_input(FeaturesServiceDidServiceEndOnTimeTrainDFSchema.to_schema(), "df")
    def preprocess_train(
        self,
        *,
        df: DataFrame[FeaturesServiceDidServiceEndOnTimeTrainDFSchema],
        test_size: float = 0.2,
    ...
    @check_input(FeaturesServiceDidServiceEndOnTimePredictDFSchema.to_schema())
    def preprocess_predict(
        self,
        df: DataFrame[FeaturesServiceDidServiceEndOnTimePredictDFSchema],
    ) -> pd.DataFrame:
        """Preprocess the data.
